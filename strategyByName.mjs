...
import { StrategyHybridRefreqyFlexDoubleRulesSimGuessMinList } from "./strategyHybridRefreqyFlexDoubleRulesSimGuessMinList.mjs";
...
export function strategyByName(name, words, strategyOptions = { }) {
    switch(name) {
        ...
        case 'hybrid':
            return new StrategyHybridRefreqyFlexDoubleRulesSimGuessMinList(words, strategyOptions);
